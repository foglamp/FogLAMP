...
Connection::Connection()
{
	...
	else
	{
		...
		rc = sqlite3_exec(dbHandle, "PRAGMA busy_timeout = 1000; PRAGMA cache_size = -4000; PRAGMA journal_mode = WAL; PRAGMA secure_delete = off; PRAGMA journal_size_limit = 4096000;", NULL, NULL, &zErrMsg);
		if (rc != SQLITE_OK)
		{
			const char* errMsg = "Failed to set 'PRAGMA busy_timeout = 1000; PRAGMA cache_size = -4000; PRAGMA journal_mode = WAL; PRAGMA secure_delete = off; PRAGMA journal_size_limit = 4096000;'";
