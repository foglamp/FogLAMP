...
async def upload(request):
    ...
    :Example:
        ...
        curl -F "cert=@filename.cer" http://localhost:8081/foglamp/certificate
        curl -F "cert=@filename.crt" http://localhost:8081/foglamp/certificate
...
async def delete_certificate(request):
    ...
    :Example:
          ...
          curl -X DELETE http://localhost:8081/foglamp/certificate/filename.cer
          curl -X DELETE http://localhost:8081/foglamp/certificate/filename.crt
