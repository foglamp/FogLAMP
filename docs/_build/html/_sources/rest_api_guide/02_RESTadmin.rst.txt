...
.. list-table::
    ...
    * - Key
      - Description
    * - BUFFERED
      - The number of readings currently in the FogLAMP buffer
    * - DISCARDED
      - The number of readings discarded at the input side by FogLAMP, i.e. discarded before being  placed in the buffer. This may be due to some error in the readings themselves.
    * - PURGED
      - The number of readings removed from the buffer by the *Purge* task
    * - READINGS
      - The number of readings received by FogLAMP since startup
    * - *NORTH_TASK_NAME*
